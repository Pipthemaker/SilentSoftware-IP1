...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButton(0))
        {
            ...
            {
                transform.position = new Vector2((gameObject.transform.position.x - (moveSpeed * Time.deltaTime)), gameObject.transform.position.y);
    ...
    {
        if (other.tag == "Stairs" && Input.GetKeyDown(KeyCode.E))
        {
